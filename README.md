...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oqropxg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oqropxg.containers.anotherwebservice.com/
...
```
git clone git@github.com:FosimaGameInc/container-oqropxg.git
cd container-oqropxg
```
...
```
docker attach container-oqropxg
```
